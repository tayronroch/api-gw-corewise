...
# Configurações
NETWORK = "10.254.254.0/24"  # Bloco de IP a ser escaneado
USERNAME = os.environ.get("DEVICE_USERNAME", "login")  # Nome de usuário via env ou padrão
PASSWORD = os.environ.get("DEVICE_PASSWORD", "senha")  # Senha via env ou padrão
