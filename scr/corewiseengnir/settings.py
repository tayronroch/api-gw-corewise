...
INSTALLED_APPS = [
    ...
    "modules.mpls_analyzer",   # Sistema MPLS Analyzer integrado
    "modules.mpls_legacy",     # Compat layer para rotas antigas do MPLS
    # "api",             # Nova app para API - será adicionada após criação
    # "dashboards",      # Nova app para dashboards - será adicionada após criação
]
MIDDLEWARE = [
...
# django-auth-ldap settings (exemplo)
# import ldap
# from django_auth_ldap.config import LDAPSearch, GroupOfNamesType

# AUTH_LDAP_SERVER_URI = "ldaps://ldap.seurede.local"
# AUTH_LDAP_BIND_DN = "cn=admin,dc=seurede,dc=local"
# AUTH_LDAP_BIND_PASSWORD = os.environ.get('LDAP_BIND_PASSWORD', '')
# AUTH_LDAP_USER_SEARCH = LDAPSearch("ou=users,dc=seurede,dc=local", ldap.SCOPE_SUBTREE, "(uid=%(user)s)")
...
USE_MOCK_TOPOLOGY = os.environ.get('USE_MOCK_TOPOLOGY', 'True').lower() == 'true'
...
# URL Configuration
ROOT_URLCONF = 'corewiseengnir.urls'

# Wsgi Application
WSGI_APPLICATION = 'corewiseengnir.wsgi.application'
