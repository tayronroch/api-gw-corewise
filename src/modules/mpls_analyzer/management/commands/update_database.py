...
from mpls_analyzer.models import BackupProcessLog
from mpls_analyzer.parsers import BackupProcessor
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        base_dir = os.path.join(settings.BASE_DIR, 'mpls_analyzer', 'scripts')
