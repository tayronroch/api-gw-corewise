...
class AuditEventAdmin(admin.ModelAdmin):
    list_display = [
        'created_at', 'action', 'user', 'ip', 'path', 'method', 'status_code', 'success', 'correlation_id'
    ]
    list_filter = ['action', 'success', 'status_code', 'created_at']
    search_fields = ['user__username', 'ip', 'path', 'correlation_id', 'user_agent']
    readonly_fields = [
        'user', 'action', 'ip', 'user_agent', 'path', 'method', 'status_code',
        'success', 'metadata', 'correlation_id', 'created_at'
    ]
